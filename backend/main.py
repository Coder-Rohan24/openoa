...
async def analyze(
    ...
    num_simulations: int = Form(1000, description="Number of Monte Carlo simulations")
):
    """
    ...
    """
    logger.info(f"Analysis requested - SCADA: {scada_file.filename}, Meter: {meter_file.filename}, Simulations: {num_simulations}")
    ...
    try:
        ...
        try:
            ...
            result = run_aep_analysis(scada_df, meter_df, num_simulations)
