...
const ExecutiveSummary = ({ primary, secondary, tertiary }: ExecutiveSummaryProps) => {
  return (
    <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg border border-blue-200 p-6 shadow-md hover:shadow-lg transition-all duration-200 hover-lift">
